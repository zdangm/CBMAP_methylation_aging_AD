...
pheno_df <- pheno_df %>% select(age, sex_male, bank, PMD, RIN, Exc, Inh, NonN_Astro_FGF3R, NonN_Endo, NonN_Micro, NonN_Oligo_MBP, NonN_OPC, Sample_Plate)
apply(pheno_df, 2, function(x){sum(is.na(x))})
# age         sex_male             bank              PMD              RIN 
#   0                0                0                5                0 
