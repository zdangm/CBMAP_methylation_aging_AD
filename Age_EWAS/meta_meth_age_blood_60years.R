...
results.files <- c("Hannum_meth_age_60years.RData","PEG1_meth_age_60years.RData","SATSA_meth_age_60years.RData")
...
save(meta_final_ordered_df,file='meta_meth_age_blood_60years.RData')