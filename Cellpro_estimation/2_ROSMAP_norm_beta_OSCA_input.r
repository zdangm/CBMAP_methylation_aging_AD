...
norm_beta_dir	<- paste("/methylation/results/ctp_analysis/ROSMAP_meffil_", "norm.beta", ".Robj", sep = "")
out_dir			<- "/methylation/results/ctp_analysis/OSCA/format_for_osca/ROSMAP_norm_beta_OSCA_input.txt"
