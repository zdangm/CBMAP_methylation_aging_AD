...
setwd('/methylation/results/disease_meth_age/DNAm_clock/MultiClock/pumctest')
source('/methylation/script/disease_meth_age/DNAm_clock/MultiClock/MultiClock.R')
...
dir <- '/methylation/script/disease_meth_age/DNAm_clock/MultiClock/'
IDcol='Sample_Name'
Agecol='age'
pre_age <- MultiClock(betas=Bdat, pheno=pheno_df, dir=dir, IDcol=IDcol, Agecol=Agecol)
