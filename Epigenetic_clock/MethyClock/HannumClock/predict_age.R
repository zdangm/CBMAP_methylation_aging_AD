...
setwd('/methylation/results/disease_meth_age/DNAm_clock/HannumClock/pumctest')
source('/methylation/script/disease_meth_age/DNAm_clock/HannumClock/HannumClock.R')
...
dir <- '/methylation/script/disease_meth_age/DNAm_clock/HannumClock/'
IDcol='Sample_Name'
Agecol='age'
pre_age <- HannumClock(betas=Bdat, pheno=pheno_df, dir=dir, IDcol=IDcol, Agecol=Agecol)