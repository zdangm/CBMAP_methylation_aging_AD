...
setwd('/methylation/results/disease_meth_age/DNAm_clock/CorticalClock/pumctest')
source('/methylation/script/disease_meth_age/DNAm_clock/CorticalClock/CorticalClock.r')
...
dir <- '/methylation/script/disease_meth_age/DNAm_clock/CorticalClock/'
IDcol='Sample_Name'
Agecol='age'
pre_age <- CorticalClock(betas=Bdat, pheno=pheno_df, dir=dir, IDcol=IDcol, Agecol=Agecol)
