...
setwd('/methylation/results/disease_meth_age/DNAm_clock/iCAS-DNAm')
source('/methylation/script/disease_meth_age/DNAm_clock/iCAS-DNAm/iCAS-DNAm.R')
...
dir <- '/methylation/script/disease_meth_age/DNAm_clock/iCAS-DNAm/'
IDcol='Sample_Name'
Agecol='age'
pre_age <- iCAS_DNAm(betas=Bdat, pheno=pheno_df, dir=dir, IDcol=IDcol, Agecol=Agecol)
